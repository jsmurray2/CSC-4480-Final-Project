...
insert into director values
(7, 'Mary Harron', '1953-01-12');

insert into director values
(8, 'Frank Marshall', '1946-09-13');
...
insert into production_studio values
('A Band Apart', '7966 Beverly Blvd., Los Angeles, California', 'Lawrence Bender');

insert into production_studio values
('Live America Inc.', '15400 Sherman Way, Van Nuys, California', 'Noel Bloom Sr.');

insert into production_studio values
('Hawk Films', null, 'Stanley Kubrick');

insert into production_studio values
('Muse Entertainment', 'Montreal, Quebec, Canada', 'Michael Prupas');

insert into production_studio values
('Touchstone Pictures', '500 South Buena Vista St., Burbank, California', 'Sean Bailey');
